package data
{
   ...
   public class MessageReceiver extends Object implements RawDataParser
   {
      ...
      
      {
         ...
         _messagesTypes[6734] = AbstractPresetSaveResultMessage;
      ...
      public static function register() : void
      {
         ...
         StoreDataManager.getInstance().registerClass(new AbstractPresetSaveResultMessage(),true,true);
      ...
      public function parse(param1:ICustomDataInput, param2:uint, param3:uint) : INetworkMessage
      {
         ...
         _loc5_.unpacked = true;
         return _loc5_;
      }
      
      public function parseAsync(param1:ICustomDataInput, param2:uint, param3:uint, param4:Function) : INetworkMessage
      {
         var _loc5_:Class = _messagesTypes[param2];
         if(!_loc5_)
         {
            _log.warn("Unknown packet received (ID " + param2 + ", length " + param3 + ")");
            return null;
         }
         var _loc6_:INetworkMessage = new _loc5_();
         _loc6_.unpacked = false;
         param4(_loc6_,_loc6_.unpackAsync(param1,param3));
         return _loc6_;
      }
      
      public function getUnpackMode(param1:uint) : uint
      {
         return param1 in _unpackModes?_unpackModes[param1]:UnpackMode.DEFAULT;
      }
   }
}
