...
public class FightCommonInformations extends Object implements INetworkType {
    ...
    private FightTeamInformations[] fightTeams;
    private int[] fightTeamsPositions;
    private FightOptionsInformations[] fightTeamsOptions;
    ...
    public void serialize(ICustomDataOutput param1) {
         ...
         while(_loc3_ < this.fightTeamsPositions.length)
         {
            ...
            {
               throw new Exception("Forbidden value (" + this.fightTeamsPositions[_loc3_] + ") on element 4 (starting at 1) of fightTeamsPositions.");
            }
    ...
    public void deserialize(ICustomDataInput param1) {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            {
               throw new Exception("Forbidden value (" + _loc10_ + ") on elements of fightTeamsPositions.");
            }
