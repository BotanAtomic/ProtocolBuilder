...
public class DecraftedItemStackInfo extends Object implements INetworkType {
    ...
    public void serialize(ICustomDataOutput param1) {
         ...
         while(_loc2_ < this.runesId.length)
         {
            ...
            {
               throw new Exception("Forbidden value (" + this.runesId[_loc2_] + ") on element 4 (starting at 1) of runesId.");
            }
         ...
         while(_loc3_ < this.runesQty.length)
         {
            ...
            {
               throw new Exception("Forbidden value (" + this.runesQty[_loc3_] + ") on element 5 (starting at 1) of runesQty.");
            }
