...
public class DebugClearHighlightCellsMessage extends NetworkMessage implements INetworkMessage {
    ...
    public void serializeAs_DebugClearHighlightCellsMessage(ICustomDataOutput param1) {
    }

    public void deserialize(ICustomDataInput param1) {
    }

    public void deserializeAs_DebugClearHighlightCellsMessage(ICustomDataInput param1) {
    }

    public void deserializeAsync(FuncTree param1) {
    }

    public void deserializeAsyncAs_DebugClearHighlightCellsMessage(FuncTree param1) {
    }
