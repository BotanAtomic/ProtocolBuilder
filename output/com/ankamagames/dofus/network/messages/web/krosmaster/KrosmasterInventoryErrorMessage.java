...
public class KrosmasterInventoryErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public KrosmasterInventoryErrorMessage initKrosmasterInventoryErrorMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_KrosmasterInventoryErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_KrosmasterInventoryErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_KrosmasterInventoryErrorMessage(FuncTree param1) {
