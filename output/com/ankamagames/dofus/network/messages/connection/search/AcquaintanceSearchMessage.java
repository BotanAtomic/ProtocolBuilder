package package com.ankamagames.dofus.network.messages.connection.search;
...
public class AcquaintanceSearchMessage extends NetworkMessage implements INetworkMessage {
    ...
    public AcquaintanceSearchMessage initAcquaintanceSearchMessage(String param1) {
    ...
    public void serializeAs_AcquaintanceSearchMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_AcquaintanceSearchMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_AcquaintanceSearchMessage(FuncTree param1) {
