...
public class SetEnablePVPRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public SetEnablePVPRequestMessage initSetEnablePVPRequestMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_SetEnablePVPRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_SetEnablePVPRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_SetEnablePVPRequestMessage(FuncTree param1) {
