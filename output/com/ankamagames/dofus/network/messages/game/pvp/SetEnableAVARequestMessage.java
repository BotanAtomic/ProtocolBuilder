...
public class SetEnableAVARequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public SetEnableAVARequestMessage initSetEnableAVARequestMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_SetEnableAVARequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_SetEnableAVARequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_SetEnableAVARequestMessage(FuncTree param1) {
