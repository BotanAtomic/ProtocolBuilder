...
public class ShortcutBarReplacedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ShortcutBarReplacedMessage initShortcutBarReplacedMessage(int param1,Shortcut  param2) {
         this.barType = param1;
    ...
    public void serializeAs_ShortcutBarReplacedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ShortcutBarReplacedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ShortcutBarReplacedMessage(FuncTree param1) {
