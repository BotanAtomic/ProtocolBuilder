...
public class ShortcutBarRemoveErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ShortcutBarRemoveErrorMessage initShortcutBarRemoveErrorMessage(int param1) {
         this.error = param1;
    ...
    public void serializeAs_ShortcutBarRemoveErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ShortcutBarRemoveErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ShortcutBarRemoveErrorMessage(FuncTree param1) {
