...
public class ShortcutBarRemoveRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ShortcutBarRemoveRequestMessage initShortcutBarRemoveRequestMessage(int param1,int  param2) {
         this.barType = param1;
         this.slot = param2;
    ...
    public void serializeAs_ShortcutBarRemoveRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ShortcutBarRemoveRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ShortcutBarRemoveRequestMessage(FuncTree param1) {
    ...
    private void _barTypeFunc(ICustomDataInput param1) {
         ...
         if(this.barType < 0)
         {
            throw new Exception("Forbidden value (" + this.barType + ") on element of ShortcutBarRemoveRequestMessage.barType.");
         }
    }
    ...
    private void _slotFunc(ICustomDataInput param1) {
         ...
         if(this.slot < 0 || this.slot > 99)
         {
            throw new Exception("Forbidden value (" + this.slot + ") on element of ShortcutBarRemoveRequestMessage.slot.");
         }
    }
