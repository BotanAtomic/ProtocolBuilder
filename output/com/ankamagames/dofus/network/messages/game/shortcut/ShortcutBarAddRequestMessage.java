...
public class ShortcutBarAddRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ShortcutBarAddRequestMessage initShortcutBarAddRequestMessage(int param1,Shortcut  param2) {
         this.barType = param1;
    ...
    public void serializeAs_ShortcutBarAddRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ShortcutBarAddRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ShortcutBarAddRequestMessage(FuncTree param1) {
