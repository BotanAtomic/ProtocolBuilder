...
public class IdolPartyRegisterRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public IdolPartyRegisterRequestMessage initIdolPartyRegisterRequestMessage(boolean param1) {
    ...
    public void serializeAs_IdolPartyRegisterRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_IdolPartyRegisterRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_IdolPartyRegisterRequestMessage(FuncTree param1) {
         param1.addChild(this._registerFunc);
    }

    private void _registerFunc(ICustomDataInput param1) {
