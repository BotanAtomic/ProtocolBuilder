...
public class ZaapRespawnUpdatedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ZaapRespawnUpdatedMessage initZaapRespawnUpdatedMessage(int param1) {
         this.mapId = param1;
    ...
    public void deserializeAs_ZaapRespawnUpdatedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ZaapRespawnUpdatedMessage(FuncTree param1) {
