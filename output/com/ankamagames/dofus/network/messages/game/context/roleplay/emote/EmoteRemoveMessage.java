...
public class EmoteRemoveMessage extends NetworkMessage implements INetworkMessage {
    ...
    public EmoteRemoveMessage initEmoteRemoveMessage(int param1) {
         this.emoteId = param1;
    ...
    public void serializeAs_EmoteRemoveMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_EmoteRemoveMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_EmoteRemoveMessage(FuncTree param1) {
