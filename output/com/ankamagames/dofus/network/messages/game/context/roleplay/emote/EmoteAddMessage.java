...
public class EmoteAddMessage extends NetworkMessage implements INetworkMessage {
    ...
    public EmoteAddMessage initEmoteAddMessage(int param1) {
         this.emoteId = param1;
    ...
    public void deserializeAs_EmoteAddMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_EmoteAddMessage(FuncTree param1) {
