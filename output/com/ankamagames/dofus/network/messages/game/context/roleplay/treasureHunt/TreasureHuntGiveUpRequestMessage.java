...
public class TreasureHuntGiveUpRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public TreasureHuntGiveUpRequestMessage initTreasureHuntGiveUpRequestMessage(int param1) {
    ...
    public void serializeAs_TreasureHuntGiveUpRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_TreasureHuntGiveUpRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_TreasureHuntGiveUpRequestMessage(FuncTree param1) {
