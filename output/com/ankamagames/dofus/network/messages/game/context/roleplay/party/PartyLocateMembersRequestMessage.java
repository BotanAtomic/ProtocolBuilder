...
public class PartyLocateMembersRequestMessage extends AbstractPartyMessage implements INetworkMessage {
    ...
    public PartyLocateMembersRequestMessage initPartyLocateMembersRequestMessage(int param1) {
    ...
    public void serializeAs_PartyLocateMembersRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyLocateMembersRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyLocateMembersRequestMessage(FuncTree param1) {
