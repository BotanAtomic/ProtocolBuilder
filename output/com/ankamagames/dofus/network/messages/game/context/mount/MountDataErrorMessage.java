...
public class MountDataErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public MountDataErrorMessage initMountDataErrorMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_MountDataErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_MountDataErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_MountDataErrorMessage(FuncTree param1) {
