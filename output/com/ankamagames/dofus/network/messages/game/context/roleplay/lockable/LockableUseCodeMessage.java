...
public class LockableUseCodeMessage extends NetworkMessage implements INetworkMessage {
    ...
    public LockableUseCodeMessage initLockableUseCodeMessage(String param1) {
         this.code = param1;
    ...
    public void serializeAs_LockableUseCodeMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_LockableUseCodeMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_LockableUseCodeMessage(FuncTree param1) {
