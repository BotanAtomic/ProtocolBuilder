...
public class StatsUpgradeResultMessage extends NetworkMessage implements INetworkMessage {
    ...
    public StatsUpgradeResultMessage initStatsUpgradeResultMessage(int param1,int  param2) {
         this.result = param1;
    ...
    public void deserializeAs_StatsUpgradeResultMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_StatsUpgradeResultMessage(FuncTree param1) {
