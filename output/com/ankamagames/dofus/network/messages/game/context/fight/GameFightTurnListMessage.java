...
public class GameFightTurnListMessage extends NetworkMessage implements INetworkMessage {
  ...
  public Vector<Number> ids;
  public Vector<Number> deadsIds;
  ...
  public void serialize(ICustomDataOutput param1) {
    ...
    while (_loc3_ < this.deadsIds.length) {
      if (this.deadsIds[_loc3_] < -9.007199254740992E15
          || this.deadsIds[_loc3_] > 9.007199254740992E15) {
        throw new Error(
            "Forbidden value ("
                + this.deadsIds[_loc3_]
                + ") on element 2 (starting at 1) of deadsIds.");
      }
