...
public class PartyRefuseInvitationNotificationMessage extends AbstractPartyEventMessage implements INetworkMessage {
    ...
    public PartyRefuseInvitationNotificationMessage initPartyRefuseInvitationNotificationMessage(int param1,Number  param2) {
    ...
    public void serializeAs_PartyRefuseInvitationNotificationMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyRefuseInvitationNotificationMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyRefuseInvitationNotificationMessage(FuncTree param1) {
