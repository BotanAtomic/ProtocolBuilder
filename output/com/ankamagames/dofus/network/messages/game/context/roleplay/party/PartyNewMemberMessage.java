...
public class PartyNewMemberMessage extends PartyUpdateMessage implements INetworkMessage {
    ...
    public PartyNewMemberMessage initPartyNewMemberMessage(int param1,PartyMemberInformations  param2) {
    ...
    public void serializeAs_PartyNewMemberMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyNewMemberMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyNewMemberMessage(FuncTree param1) {
