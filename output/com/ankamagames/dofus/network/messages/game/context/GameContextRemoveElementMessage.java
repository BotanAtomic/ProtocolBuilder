...
public class GameContextRemoveElementMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GameContextRemoveElementMessage initGameContextRemoveElementMessage(Number param1) {
         this.id = param1;
    ...
    public void serializeAs_GameContextRemoveElementMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameContextRemoveElementMessage(ICustomDataInput param1) {
         this._idFunc(param1);
    }
    ...
    public void deserializeAsyncAs_GameContextRemoveElementMessage(FuncTree param1) {
