...
public class PartyRestrictedMessage extends AbstractPartyMessage implements INetworkMessage {
    ...
    public PartyRestrictedMessage initPartyRestrictedMessage(int param1,boolean  param2) {
    ...
    public void serializeAs_PartyRestrictedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyRestrictedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyRestrictedMessage(FuncTree param1) {
