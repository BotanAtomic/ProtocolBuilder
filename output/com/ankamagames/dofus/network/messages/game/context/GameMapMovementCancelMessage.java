...
public class GameMapMovementCancelMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GameMapMovementCancelMessage initGameMapMovementCancelMessage(int param1) {
         this.cellId = param1;
    ...
    public void serializeAs_GameMapMovementCancelMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameMapMovementCancelMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameMapMovementCancelMessage(FuncTree param1) {
