...
public class MapInformationsRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public MapInformationsRequestMessage initMapInformationsRequestMessage(int param1) {
         this.mapId = param1;
    ...
    public void serializeAs_MapInformationsRequestMessage(ICustomDataOutput param1) {
         if(this.mapId < 0)
    ...
    public void deserializeAs_MapInformationsRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_MapInformationsRequestMessage(FuncTree param1) {
    ...
    private void _mapIdFunc(ICustomDataInput param1) {
         ...
         if(this.mapId < 0)
            throw new Exception("Forbidden value (" + this.mapId + ") on element of MapInformationsRequestMessage.mapId.");
    }
