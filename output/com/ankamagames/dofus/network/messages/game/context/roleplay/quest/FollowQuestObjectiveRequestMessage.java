...
public class FollowQuestObjectiveRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public FollowQuestObjectiveRequestMessage initFollowQuestObjectiveRequestMessage(int param1,int  param2) {
         this.questId = param1;
    ...
    public void deserializeAs_FollowQuestObjectiveRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_FollowQuestObjectiveRequestMessage(FuncTree param1) {
