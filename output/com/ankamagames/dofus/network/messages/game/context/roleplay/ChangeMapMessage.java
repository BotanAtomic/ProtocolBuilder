...
public class ChangeMapMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ChangeMapMessage initChangeMapMessage(int param1) {
         this.mapId = param1;
    ...
    public void serializeAs_ChangeMapMessage(ICustomDataOutput param1) {
         if(this.mapId < 0)
    ...
    public void deserializeAs_ChangeMapMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ChangeMapMessage(FuncTree param1) {
