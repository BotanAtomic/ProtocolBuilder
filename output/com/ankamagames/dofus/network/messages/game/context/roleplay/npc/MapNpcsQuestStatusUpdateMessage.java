...
public class MapNpcsQuestStatusUpdateMessage extends NetworkMessage implements INetworkMessage {
  ...
  public int mapId = 0;
  public Vector<Integer> npcsIdsWithQuest;
  public Vector<GameRolePlayNpcQuestFlag> questFlags;
  public Vector<Integer> npcsIdsWithoutQuest;
  ...
  public void serialize(ICustomDataOutput param1) {
    ...
    while (_loc3_ < this.questFlags.length) {
      ((GameRolePlayNpcQuestFlag) this.questFlags[_loc3_]).serializeAs_(param1);
      _loc3_++;
    }
