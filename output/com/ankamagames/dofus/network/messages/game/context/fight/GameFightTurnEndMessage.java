...
public class GameFightTurnEndMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GameFightTurnEndMessage initGameFightTurnEndMessage(Number param1) {
         this.id = param1;
    ...
    public void deserializeAs_GameFightTurnEndMessage(ICustomDataInput param1) {
         this._idFunc(param1);
    }
    ...
    public void deserializeAsyncAs_GameFightTurnEndMessage(FuncTree param1) {
