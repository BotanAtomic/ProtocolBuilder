...
public class DungeonKeyRingMessage extends NetworkMessage implements INetworkMessage {
  ...
  public Vector<uint> availables;
  public Vector<uint> unavailables;
  ...
  public void serialize(ICustomDataOutput param1) {
    ...
    while (_loc2_ < this.availables.length) {
      if (this.availables[_loc2_] < 0) {
        throw new Exception(
            "Forbidden value ("
                + this.availables[_loc2_]
                + ") on element 1 (starting at 1) of availables.");
      }
    ...
    while (_loc3_ < this.unavailables.length) {
      if (this.unavailables[_loc3_] < 0) {
        throw new Exception(
            "Forbidden value ("
                + this.unavailables[_loc3_]
                + ") on element 2 (starting at 1) of unavailables.");
      }
