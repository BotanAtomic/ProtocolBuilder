...
public class PartyCancelInvitationMessage extends AbstractPartyMessage implements INetworkMessage {
    ...
    public PartyCancelInvitationMessage initPartyCancelInvitationMessage(int param1,Number  param2) {
    ...
    public void deserializeAs_PartyCancelInvitationMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyCancelInvitationMessage(FuncTree param1) {
