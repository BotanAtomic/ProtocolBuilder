...
public class MountReleasedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public MountReleasedMessage initMountReleasedMessage(int param1) {
         this.mountId = param1;
    ...
    public void serializeAs_MountReleasedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_MountReleasedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_MountReleasedMessage(FuncTree param1) {
