...
public class PartyNameSetRequestMessage extends AbstractPartyMessage implements INetworkMessage {
    ...
    public PartyNameSetRequestMessage initPartyNameSetRequestMessage(int param1,String  param2) {
    ...
    public void serializeAs_PartyNameSetRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyNameSetRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyNameSetRequestMessage(FuncTree param1) {
