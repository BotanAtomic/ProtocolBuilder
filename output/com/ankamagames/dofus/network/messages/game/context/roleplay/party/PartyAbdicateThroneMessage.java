...
public class PartyAbdicateThroneMessage extends AbstractPartyMessage implements INetworkMessage {
    ...
    public PartyAbdicateThroneMessage initPartyAbdicateThroneMessage(int param1,Number  param2) {
    ...
    public void serializeAs_PartyAbdicateThroneMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_PartyAbdicateThroneMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PartyAbdicateThroneMessage(FuncTree param1) {
