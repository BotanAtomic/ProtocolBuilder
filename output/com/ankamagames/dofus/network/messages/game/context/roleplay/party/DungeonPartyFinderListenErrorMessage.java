...
public class DungeonPartyFinderListenErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public DungeonPartyFinderListenErrorMessage initDungeonPartyFinderListenErrorMessage(int param1) {
    ...
    public void deserializeAs_DungeonPartyFinderListenErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_DungeonPartyFinderListenErrorMessage(FuncTree param1) {
