...
public class ExchangeObjectModifiedMessage extends ExchangeObjectMessage implements INetworkMessage {
    ...
    public ExchangeObjectModifiedMessage initExchangeObjectModifiedMessage(boolean param1,ObjectItem  param2) {
    ...
    public void serializeAs_ExchangeObjectModifiedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeObjectModifiedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeObjectModifiedMessage(FuncTree param1) {
