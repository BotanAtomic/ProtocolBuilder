...
public class ExchangeObjectPutInBagMessage extends ExchangeObjectMessage implements INetworkMessage {
    ...
    public ExchangeObjectPutInBagMessage initExchangeObjectPutInBagMessage(boolean param1,ObjectItem  param2) {
    ...
    public void serializeAs_ExchangeObjectPutInBagMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeObjectPutInBagMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeObjectPutInBagMessage(FuncTree param1) {
