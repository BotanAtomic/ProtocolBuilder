...
public class ObjectAddedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ObjectAddedMessage initObjectAddedMessage(ObjectItem param1) {
         this.object = param1;
    ...
    public void serializeAs_ObjectAddedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ObjectAddedMessage(ICustomDataInput param1) {
         this.object = new ObjectItem();
    ...
    public void deserializeAsyncAs_ObjectAddedMessage(FuncTree param1) {
