...
public class ExchangeStoppedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeStoppedMessage initExchangeStoppedMessage(Number param1) {
         this.id = param1;
    ...
    public void deserializeAs_ExchangeStoppedMessage(ICustomDataInput param1) {
         this._idFunc(param1);
    }
    ...
    public void deserializeAsyncAs_ExchangeStoppedMessage(FuncTree param1) {
