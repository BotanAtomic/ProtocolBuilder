...
public class ExchangeObjectRemovedMessage extends ExchangeObjectMessage implements INetworkMessage {
    ...
    public ExchangeObjectRemovedMessage initExchangeObjectRemovedMessage(boolean param1,int  param2) {
    ...
    public void serializeAs_ExchangeObjectRemovedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeObjectRemovedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeObjectRemovedMessage(FuncTree param1) {
