...
public class ExchangeRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeRequestMessage initExchangeRequestMessage(int param1) {
    ...
    public void serializeAs_ExchangeRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeRequestMessage(FuncTree param1) {
