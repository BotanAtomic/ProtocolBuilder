...
public class ExchangeMountsStableRemoveMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeMountsStableRemoveMessage initExchangeMountsStableRemoveMessage(Vector<int> param1) {
    ...
    public void serializeAs_ExchangeMountsStableRemoveMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeMountsStableRemoveMessage(ICustomDataInput param1) {
         * _loc4_ = 0;
    ...
    public void deserializeAsyncAs_ExchangeMountsStableRemoveMessage(FuncTree param1) {
