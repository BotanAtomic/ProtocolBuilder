...
public class KamasUpdateMessage extends NetworkMessage implements INetworkMessage {
    ...
    public KamasUpdateMessage initKamasUpdateMessage(Number param1) {
    ...
    public void serializeAs_KamasUpdateMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_KamasUpdateMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_KamasUpdateMessage(FuncTree param1) {
