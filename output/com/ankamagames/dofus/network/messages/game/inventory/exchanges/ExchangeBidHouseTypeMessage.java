...
public class ExchangeBidHouseTypeMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeBidHouseTypeMessage initExchangeBidHouseTypeMessage(int param1) {
         this.type = param1;
    ...
    public void deserializeAs_ExchangeBidHouseTypeMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeBidHouseTypeMessage(FuncTree param1) {
