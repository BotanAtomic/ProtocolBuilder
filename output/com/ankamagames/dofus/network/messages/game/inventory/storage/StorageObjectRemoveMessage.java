...
public class StorageObjectRemoveMessage extends NetworkMessage implements INetworkMessage {
    ...
    public StorageObjectRemoveMessage initStorageObjectRemoveMessage(int param1) {
    ...
    public void deserializeAs_StorageObjectRemoveMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_StorageObjectRemoveMessage(FuncTree param1) {
