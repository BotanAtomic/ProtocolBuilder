...
public class ExchangeMountSterilizeFromPaddockMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeMountSterilizeFromPaddockMessage initExchangeMountSterilizeFromPaddockMessage(String param1,int  param2,int  param3,String  param4) {
         this.name = param1;
         this.worldX = param2;
         this.worldY = param3;
    ...
    public void deserializeAs_ExchangeMountSterilizeFromPaddockMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeMountSterilizeFromPaddockMessage(FuncTree param1) {
