...
public class WrapperObjectErrorMessage extends SymbioticObjectErrorMessage implements INetworkMessage {
    ...
    public WrapperObjectErrorMessage initWrapperObjectErrorMessage(int param1,int  param2) {
    ...
    public void serializeAs_WrapperObjectErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_WrapperObjectErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_WrapperObjectErrorMessage(FuncTree param1) {
