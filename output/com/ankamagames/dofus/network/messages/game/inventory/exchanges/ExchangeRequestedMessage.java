...
public class ExchangeRequestedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ExchangeRequestedMessage initExchangeRequestedMessage(int param1) {
    ...
    public void serializeAs_ExchangeRequestedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ExchangeRequestedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ExchangeRequestedMessage(FuncTree param1) {
