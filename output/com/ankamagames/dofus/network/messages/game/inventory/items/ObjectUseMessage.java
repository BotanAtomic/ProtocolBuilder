...
public class ObjectUseMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ObjectUseMessage initObjectUseMessage(int param1) {
    ...
    public void serializeAs_ObjectUseMessage(ICustomDataOutput param1) {
         if(this.objectUID < 0)
    ...
    public void deserializeAs_ObjectUseMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ObjectUseMessage(FuncTree param1) {
