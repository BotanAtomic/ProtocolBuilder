...
public class ChatCommunityChannelCommunityMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ChatCommunityChannelCommunityMessage initChatCommunityChannelCommunityMessage(int param1) {
    ...
    public void serializeAs_ChatCommunityChannelCommunityMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ChatCommunityChannelCommunityMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ChatCommunityChannelCommunityMessage(FuncTree param1) {
