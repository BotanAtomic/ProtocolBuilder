...
public class ChannelEnablingMessage extends NetworkMessage implements INetworkMessage {
    ...
    public ChannelEnablingMessage initChannelEnablingMessage(int param1,boolean  param2) {
         this.channel = param1;
         this.enable = param2;
    ...
    public void serializeAs_ChannelEnablingMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_ChannelEnablingMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_ChannelEnablingMessage(FuncTree param1) {
