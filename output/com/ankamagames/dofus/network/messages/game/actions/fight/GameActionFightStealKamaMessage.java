...
public class GameActionFightStealKamaMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightStealKamaMessage initGameActionFightStealKamaMessage(int param1,Number  param2,Number  param3,Number  param4) {
    ...
    public void serializeAs_GameActionFightStealKamaMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameActionFightStealKamaMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightStealKamaMessage(FuncTree param1) {
