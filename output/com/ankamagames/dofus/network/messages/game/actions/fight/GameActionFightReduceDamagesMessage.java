...
public class GameActionFightReduceDamagesMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightReduceDamagesMessage initGameActionFightReduceDamagesMessage(int param1,Number  param2,Number  param3,int  param4) {
    ...
    public void serializeAs_GameActionFightReduceDamagesMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameActionFightReduceDamagesMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightReduceDamagesMessage(FuncTree param1) {
    ...
    private void _targetIdFunc(ICustomDataInput param1) {
         ...
         if(this.targetId < -9.007199254740992E15 || this.targetId > 9.007199254740992E15)
         {
            throw new Exception("Forbidden value (" + this.targetId + ") on element of GameActionFightReduceDamagesMessage.targetId.");
         }
    }
    ...
    private void _amountFunc(ICustomDataInput param1) {
         ...
         if(this.amount < 0)
         {
            throw new Exception("Forbidden value (" + this.amount + ") on element of GameActionFightReduceDamagesMessage.amount.");
         }
    }
