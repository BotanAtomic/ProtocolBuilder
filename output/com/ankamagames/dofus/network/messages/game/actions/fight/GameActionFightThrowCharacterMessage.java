...
public class GameActionFightThrowCharacterMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightThrowCharacterMessage initGameActionFightThrowCharacterMessage(int param1,Number  param2,Number  param3,int  param4) {
    ...
    public void deserializeAs_GameActionFightThrowCharacterMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightThrowCharacterMessage(FuncTree param1) {
