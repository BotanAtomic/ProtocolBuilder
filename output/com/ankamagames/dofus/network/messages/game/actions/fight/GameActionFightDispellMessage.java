...
public class GameActionFightDispellMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightDispellMessage initGameActionFightDispellMessage(int param1,Number  param2,Number  param3) {
    ...
    public void serializeAs_GameActionFightDispellMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameActionFightDispellMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightDispellMessage(FuncTree param1) {
