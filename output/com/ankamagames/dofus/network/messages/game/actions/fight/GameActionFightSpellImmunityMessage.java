...
public class GameActionFightSpellImmunityMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightSpellImmunityMessage initGameActionFightSpellImmunityMessage(int param1,Number  param2,Number  param3,int  param4) {
    ...
    public void serializeAs_GameActionFightSpellImmunityMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameActionFightSpellImmunityMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightSpellImmunityMessage(FuncTree param1) {
    ...
    private void _targetIdFunc(ICustomDataInput param1) {
         ...
         if(this.targetId < -9.007199254740992E15 || this.targetId > 9.007199254740992E15)
         {
            throw new Exception("Forbidden value (" + this.targetId + ") on element of GameActionFightSpellImmunityMessage.targetId.");
         }
    }
