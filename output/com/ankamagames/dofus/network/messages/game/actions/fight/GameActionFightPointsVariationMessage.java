...
public class GameActionFightPointsVariationMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightPointsVariationMessage initGameActionFightPointsVariationMessage(int param1,Number  param2,Number  param3,int  param4) {
    ...
    public void deserializeAs_GameActionFightPointsVariationMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightPointsVariationMessage(FuncTree param1) {
