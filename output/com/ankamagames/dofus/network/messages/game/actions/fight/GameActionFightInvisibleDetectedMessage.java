...
public class GameActionFightInvisibleDetectedMessage extends AbstractGameActionMessage implements INetworkMessage {
    ...
    public GameActionFightInvisibleDetectedMessage initGameActionFightInvisibleDetectedMessage(int param1,Number  param2,Number  param3,int  param4) {
    ...
    public void serializeAs_GameActionFightInvisibleDetectedMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GameActionFightInvisibleDetectedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GameActionFightInvisibleDetectedMessage(FuncTree param1) {
