...
public class TitleGainedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public TitleGainedMessage initTitleGainedMessage(int param1) {
         this.titleId = param1;
    ...
    public void serializeAs_TitleGainedMessage(ICustomDataOutput param1) {
         if(this.titleId < 0)
    ...
    public void deserializeAs_TitleGainedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_TitleGainedMessage(FuncTree param1) {
