...
public class TitleLostMessage extends NetworkMessage implements INetworkMessage {
    ...
    public TitleLostMessage initTitleLostMessage(int param1) {
         this.titleId = param1;
    ...
    public void serializeAs_TitleLostMessage(ICustomDataOutput param1) {
         if(this.titleId < 0)
    ...
    public void deserializeAs_TitleLostMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_TitleLostMessage(FuncTree param1) {
    ...
    private void _titleIdFunc(ICustomDataInput param1) {
         ...
         if(this.titleId < 0)
            throw new Exception("Forbidden value (" + this.titleId + ") on element of TitleLostMessage.titleId.");
    }
