...
public class DareWonMessage extends NetworkMessage implements INetworkMessage {
    ...
    public DareWonMessage initDareWonMessage(Number param1) {
         this.dareId = param1;
    ...
    public void serializeAs_DareWonMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_DareWonMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_DareWonMessage(FuncTree param1) {
    ...
    private void _dareIdFunc(ICustomDataInput param1) {
         ...
         if(this.dareId < 0 || this.dareId > 9.007199254740992E15)
         {
            throw new Exception("Forbidden value (" + this.dareId + ") on element of DareWonMessage.dareId.");
         }
    }
