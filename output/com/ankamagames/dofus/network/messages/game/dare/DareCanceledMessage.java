...
public class DareCanceledMessage extends NetworkMessage implements INetworkMessage {
    ...
    public DareCanceledMessage initDareCanceledMessage(Number param1) {
         this.dareId = param1;
    ...
    public void serializeAs_DareCanceledMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_DareCanceledMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_DareCanceledMessage(FuncTree param1) {
