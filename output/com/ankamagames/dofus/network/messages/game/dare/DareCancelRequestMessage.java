...
public class DareCancelRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public DareCancelRequestMessage initDareCancelRequestMessage(Number param1) {
         this.dareId = param1;
    ...
    public void serializeAs_DareCancelRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_DareCancelRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_DareCancelRequestMessage(FuncTree param1) {
    ...
    private void _dareIdFunc(ICustomDataInput param1) {
         ...
         if(this.dareId < 0 || this.dareId > 9.007199254740992E15)
         {
            throw new Exception("Forbidden value (" + this.dareId + ") on element of DareCancelRequestMessage.dareId.");
         }
    }
