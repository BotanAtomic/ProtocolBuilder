...
public class IgnoredListMessage extends NetworkMessage implements INetworkMessage {
  ...
  public Vector<IgnoredInformations> ignoredList;
  ...
  public void serialize(ICustomDataOutput param1) {
    ...
    while (_loc2_ < this.ignoredList.length) {
      param1.writeShort(((IgnoredInformations) (this.ignoredList[_loc2_])).getTypeId());
      ((IgnoredInformations) this.ignoredList[_loc2_]).serialize(param1);
      _loc2_++;
    }
  }
