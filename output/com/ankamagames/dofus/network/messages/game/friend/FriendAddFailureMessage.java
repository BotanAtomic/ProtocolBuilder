...
public class FriendAddFailureMessage extends NetworkMessage implements INetworkMessage {
    ...
    public FriendAddFailureMessage initFriendAddFailureMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_FriendAddFailureMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_FriendAddFailureMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_FriendAddFailureMessage(FuncTree param1) {
