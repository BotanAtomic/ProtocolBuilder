...
public class IgnoredAddFailureMessage extends NetworkMessage implements INetworkMessage {
    ...
    public IgnoredAddFailureMessage initIgnoredAddFailureMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_IgnoredAddFailureMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_IgnoredAddFailureMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_IgnoredAddFailureMessage(FuncTree param1) {
