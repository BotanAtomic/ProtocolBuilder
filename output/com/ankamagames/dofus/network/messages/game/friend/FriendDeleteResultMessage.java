...
public class FriendDeleteResultMessage extends NetworkMessage implements INetworkMessage {
    ...
    public FriendDeleteResultMessage initFriendDeleteResultMessage(boolean param1,String  param2) {
         this.success = param1;
         this.name = param2;
    ...
    public void serializeAs_FriendDeleteResultMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_FriendDeleteResultMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_FriendDeleteResultMessage(FuncTree param1) {
