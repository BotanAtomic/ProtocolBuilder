...
public class WarnOnPermaDeathStateMessage extends NetworkMessage implements INetworkMessage {
    ...
    public WarnOnPermaDeathStateMessage initWarnOnPermaDeathStateMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_WarnOnPermaDeathStateMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_WarnOnPermaDeathStateMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_WarnOnPermaDeathStateMessage(FuncTree param1) {
