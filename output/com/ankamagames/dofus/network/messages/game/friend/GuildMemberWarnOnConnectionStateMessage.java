...
public class GuildMemberWarnOnConnectionStateMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GuildMemberWarnOnConnectionStateMessage initGuildMemberWarnOnConnectionStateMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_GuildMemberWarnOnConnectionStateMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GuildMemberWarnOnConnectionStateMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GuildMemberWarnOnConnectionStateMessage(FuncTree param1) {
