...
public class PrismSetSabotagedRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public PrismSetSabotagedRequestMessage initPrismSetSabotagedRequestMessage(int param1) {
    ...
    public void deserializeAs_PrismSetSabotagedRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PrismSetSabotagedRequestMessage(FuncTree param1) {
