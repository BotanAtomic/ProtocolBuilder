...
public class PrismFightSwapRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public PrismFightSwapRequestMessage initPrismFightSwapRequestMessage(int param1,Number  param2) {
    ...
    public void serializeAs_PrismFightSwapRequestMessage(ICustomDataOutput param1) {
         if(this.subAreaId < 0)
    ...
    public void deserializeAs_PrismFightSwapRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PrismFightSwapRequestMessage(FuncTree param1) {
