...
public class PrismFightRemovedMessage extends NetworkMessage implements INetworkMessage {
    ...
    public PrismFightRemovedMessage initPrismFightRemovedMessage(int param1) {
    ...
    public void serializeAs_PrismFightRemovedMessage(ICustomDataOutput param1) {
         if(this.subAreaId < 0)
         {
    ...
    public void deserializeAs_PrismFightRemovedMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_PrismFightRemovedMessage(FuncTree param1) {
