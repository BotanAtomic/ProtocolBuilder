...
public class CharacterDeletionErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public CharacterDeletionErrorMessage initCharacterDeletionErrorMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_CharacterDeletionErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_CharacterDeletionErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_CharacterDeletionErrorMessage(FuncTree param1) {
