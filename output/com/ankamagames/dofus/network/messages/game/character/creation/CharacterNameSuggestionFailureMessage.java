...
public class CharacterNameSuggestionFailureMessage extends NetworkMessage implements INetworkMessage {
    ...
    public CharacterNameSuggestionFailureMessage initCharacterNameSuggestionFailureMessage(int param1) {
         this.reason = param1;
    ...
    public void serializeAs_CharacterNameSuggestionFailureMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_CharacterNameSuggestionFailureMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_CharacterNameSuggestionFailureMessage(FuncTree param1) {
