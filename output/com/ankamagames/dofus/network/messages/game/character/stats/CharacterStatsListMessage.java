...
public class CharacterStatsListMessage extends NetworkMessage implements INetworkMessage {
    ...
    public CharacterStatsListMessage initCharacterStatsListMessage(CharacterCharacteristicsInformations param1) {
         this.stats = param1;
    ...
    public void serializeAs_CharacterStatsListMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_CharacterStatsListMessage(ICustomDataInput param1) {
         this.stats = new CharacterCharacteristicsInformations();
    ...
    public void deserializeAsyncAs_CharacterStatsListMessage(FuncTree param1) {
