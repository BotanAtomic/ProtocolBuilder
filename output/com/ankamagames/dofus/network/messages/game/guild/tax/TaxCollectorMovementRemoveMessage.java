...
public class TaxCollectorMovementRemoveMessage extends NetworkMessage implements INetworkMessage {
    ...
    public TaxCollectorMovementRemoveMessage initTaxCollectorMovementRemoveMessage(int param1) {
    ...
    public void serializeAs_TaxCollectorMovementRemoveMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_TaxCollectorMovementRemoveMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_TaxCollectorMovementRemoveMessage(FuncTree param1) {
