...
public class GuildMotdSetErrorMessage extends SocialNoticeSetErrorMessage implements INetworkMessage {
    ...
    public GuildMotdSetErrorMessage initGuildMotdSetErrorMessage(int param1) {
    ...
    public void serializeAs_GuildMotdSetErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GuildMotdSetErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GuildMotdSetErrorMessage(FuncTree param1) {
