...
public class GuildHouseRemoveMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GuildHouseRemoveMessage initGuildHouseRemoveMessage(int param1,int  param2,boolean  param3) {
         this.houseId = param1;
    ...
    public void deserializeAs_GuildHouseRemoveMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GuildHouseRemoveMessage(FuncTree param1) {
