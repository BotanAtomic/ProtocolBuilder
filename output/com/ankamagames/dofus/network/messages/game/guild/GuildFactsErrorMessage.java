...
public class GuildFactsErrorMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GuildFactsErrorMessage initGuildFactsErrorMessage(int param1) {
         this.guildId = param1;
    ...
    public void serializeAs_GuildFactsErrorMessage(ICustomDataOutput param1) {
         if(this.guildId < 0)
    ...
    public void deserializeAs_GuildFactsErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GuildFactsErrorMessage(FuncTree param1) {
