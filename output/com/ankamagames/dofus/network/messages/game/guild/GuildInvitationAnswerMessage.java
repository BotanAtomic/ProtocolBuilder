...
public class GuildInvitationAnswerMessage extends NetworkMessage implements INetworkMessage {
    ...
    public GuildInvitationAnswerMessage initGuildInvitationAnswerMessage(boolean param1) {
         this.accept = param1;
    ...
    public void serializeAs_GuildInvitationAnswerMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_GuildInvitationAnswerMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_GuildInvitationAnswerMessage(FuncTree param1) {
