...
public class FriendGuildWarnOnAchievementCompleteStateMessage extends NetworkMessage implements INetworkMessage {
    ...
    public FriendGuildWarnOnAchievementCompleteStateMessage initFriendGuildWarnOnAchievementCompleteStateMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_FriendGuildWarnOnAchievementCompleteStateMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_FriendGuildWarnOnAchievementCompleteStateMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_FriendGuildWarnOnAchievementCompleteStateMessage(FuncTree param1) {
