...
public class AchievementRewardRequestMessage extends NetworkMessage implements INetworkMessage {
    ...
    public AchievementRewardRequestMessage initAchievementRewardRequestMessage(int param1) {
    ...
    public void serializeAs_AchievementRewardRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_AchievementRewardRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_AchievementRewardRequestMessage(FuncTree param1) {
