...
public class FriendGuildSetWarnOnAchievementCompleteMessage extends NetworkMessage implements INetworkMessage {
    ...
    public FriendGuildSetWarnOnAchievementCompleteMessage initFriendGuildSetWarnOnAchievementCompleteMessage(boolean param1) {
         this.enable = param1;
    ...
    public void serializeAs_FriendGuildSetWarnOnAchievementCompleteMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_FriendGuildSetWarnOnAchievementCompleteMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_FriendGuildSetWarnOnAchievementCompleteMessage(FuncTree param1) {
