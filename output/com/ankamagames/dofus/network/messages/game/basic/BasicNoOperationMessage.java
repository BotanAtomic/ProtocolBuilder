...
public class BasicNoOperationMessage extends NetworkMessage implements INetworkMessage {
    ...
    public void serializeAs_BasicNoOperationMessage(ICustomDataOutput param1) {
    }

    public void deserialize(ICustomDataInput param1) {
    }

    public void deserializeAs_BasicNoOperationMessage(ICustomDataInput param1) {
    }

    public void deserializeAsync(FuncTree param1) {
    }

    public void deserializeAsyncAs_BasicNoOperationMessage(FuncTree param1) {
    }
