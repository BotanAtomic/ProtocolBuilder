...
public class AllianceMotdSetRequestMessage extends SocialNoticeSetRequestMessage implements INetworkMessage {
    ...
    public AllianceMotdSetRequestMessage initAllianceMotdSetRequestMessage(String param1) {
         this.content = param1;
    ...
    public void serializeAs_AllianceMotdSetRequestMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_AllianceMotdSetRequestMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_AllianceMotdSetRequestMessage(FuncTree param1) {
