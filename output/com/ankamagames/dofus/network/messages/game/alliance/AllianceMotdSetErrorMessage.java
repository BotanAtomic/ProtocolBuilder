...
public class AllianceMotdSetErrorMessage extends SocialNoticeSetErrorMessage implements INetworkMessage {
    ...
    public AllianceMotdSetErrorMessage initAllianceMotdSetErrorMessage(int param1) {
    ...
    public void serializeAs_AllianceMotdSetErrorMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_AllianceMotdSetErrorMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_AllianceMotdSetErrorMessage(FuncTree param1) {
