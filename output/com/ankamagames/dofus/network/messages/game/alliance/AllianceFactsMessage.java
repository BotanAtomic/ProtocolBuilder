...
public class AllianceFactsMessage extends NetworkMessage implements INetworkMessage {
  ...
  public Vector<GuildInAllianceInformations> guilds;
  public Vector<uint> controlledSubareaIds;
  public Number leaderCharacterId = 0;
  ...
  public void serialize(ICustomDataOutput param1) {
    ...
    while (_loc2_ < this.guilds.length) {
      ((GuildInAllianceInformations) this.guilds[_loc2_]).serializeAs_(param1);
      _loc2_++;
    }
