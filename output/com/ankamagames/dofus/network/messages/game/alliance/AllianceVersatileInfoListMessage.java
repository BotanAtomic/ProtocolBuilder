...
public class AllianceVersatileInfoListMessage extends NetworkMessage implements INetworkMessage {
    ...
    private Vector<AllianceVersatileInformations> alliances;
    ...
    public AllianceVersatileInfoListMessage initAllianceVersatileInfoListMessage(Vector<AllianceVersatileInformations> param1) {
    ...
    public void serializeAs_AllianceVersatileInfoListMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_AllianceVersatileInfoListMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_AllianceVersatileInfoListMessage(FuncTree param1) {
    ...
    private void _alliancesFunc(ICustomDataInput param1) {
         AllianceVersatileInformations _loc2_ = new AllianceVersatileInformations();
