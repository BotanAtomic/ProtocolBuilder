package package com.ankamagames.dofus.network.messages.queues;
...
public class LoginQueueStatusMessage extends NetworkMessage implements INetworkMessage {
    ...
    public LoginQueueStatusMessage initLoginQueueStatusMessage(int param1,int  param2) {
    ...
    public void serializeAs_LoginQueueStatusMessage(ICustomDataOutput param1) {
    ...
    public void deserializeAs_LoginQueueStatusMessage(ICustomDataInput param1) {
    ...
    public void deserializeAsyncAs_LoginQueueStatusMessage(FuncTree param1) {
